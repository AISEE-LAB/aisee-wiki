...
- 当前问题：`/learn/` 目前只是占位式推荐入口，尚未承载用户确认的 AI Coding 入门主线，也没有形成从认知、工具、环境、Codex 配置到第一个项目的完整路径。
...
- 将 `/learn/` 从占位入口升级为 AI Coding 入门路径首页，明确“入门准备 -> 第一个项目 -> 进阶方法论”的阅读顺序。
- 新增 5 篇中文学习路径正文，覆盖 AI Coding 认知、工具与模型选型、基础运行环境、Codex 安装配置、第一个 AI Coding 项目。
...
- 在工具与模型相关页面展示 Codex、Claude、Gemini、GLM 等工具或模型 logo，并按 LobeHub Icons 说明使用 `@lobehub/icons` 的静态 CDN/SVG 能力或封装后的 Vue 组件方式获取图标资源。
...
| 页面 | `/learn/`、`/learn/ai-coding-intro/`、`/learn/tools-and-models/`、`/learn/dev-environment/`、`/learn/codex-setup/`、`/learn/first-ai-coding-project/` | 新增或改写中文正文。 |
...
- [ ] `/learn/` 首页已改写为 AI Coding 入门路径总览，包含入门准备、实战项目、进阶方法论三段式导读。
- [ ] 5 篇中文正文已创建并达到可发布内容，不是占位页或纯大纲。
- [ ] `tools-and-models` 页面包含 Codex、Claude、Gemini、GLM 等工具或模型的定位、适用场景、便捷程度和选择矩阵。
