...
> 本文件描述项目技术上下文。AI 行为规则见 `AGENTS.md`。
> 最后更新：2026-05-23
...
当前项目是 VuePress + vuepress-theme-plume 静态文档站。站点源码以 `site/` 为唯一 VuePress 源目录，包含 `.vuepress/` 配置、中文示例页面和英文 locale 入口。`docs/` 保留为 aisee 规划链路和协作产物目录。
...
| 站点源码 | `site/` | 唯一 VuePress 发布源，承载中文、英文、栏目、资源和静态资产。 |
