...
1. OpenSpec 是什么：AI 编程时代为什么需要规范层
2. OpenSpec 心智模型：specs、changes、artifacts 与 archive
3. OpenSpec 基础工作流：从 propose 到 archive
4. Artifact 写法指南：proposal、spec、design、tasks 分别怎么写
5. Spec 粒度设计：项目级、模块级、能力级如何划分
6. Delta Spec 深度解析
7. OpenSpec Schema 是什么
8. OpenSpec 的适用边界
