...
<p align="center">
  <strong>Open methodology and practice docs for OpenSpec, Compound Engineering, and AISEE workflows.</strong>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/AISEE-LAB/aisee-plugin">AISEE Plugin Repo</a> ·
...
- 公开站点内容主要位于 `site/`
- OpenSpec 相关事实源与 change 位于 `openspec/`
- 协作材料位于 `docs/`，但不会直接作为公开站点发布源

如果你要修改站点内容或结构，建议至少先检查相关 OpenSpec artifacts，再进行本地预览或构建验证。
